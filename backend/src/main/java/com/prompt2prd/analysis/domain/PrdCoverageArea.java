...
public enum PrdCoverageArea {
    ...
    PAGES_STATES("pagesStates", "页面清单与页面状态", RequirementDimension.PAGES_APIS,
            "pages, page purpose, access roles, empty/loading/error/success states"),
    ...
    API_REQUIREMENTS("apiRequirements", "接口需求", RequirementDimension.PAGES_APIS,
            "API operations, parameters, responses, business error codes"),
